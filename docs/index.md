...
graph LR
    t1["<b>要件定義</b>"]:::defaultBox
    t2["<b>技術選定</b>"]:::defaultBox
    t3["<b>環境構築</b>"]:::defaultBox
    t4["<b>コーディング</b>"]:::defaultBox
    t5["<b>テスト</b>"]:::defaultBox
    t6["<b>デバッグ</b>"]:::defaultBox
    t7["<b>完成</b>"]:::defaultBox
...
%%{init: {'theme':'base', 'themeVariables': { 'fontSize':'14px'}}}%%
graph LR
    m1["<b>要件定義</b>"]:::defaultBox
    m2["<b>Building Blocks</b><br/><b>インストール</b>"]:::bbBox
    m3["<b>IBM Bob で</b><br/><b>カスタマイズ</b>"]:::bobBox
    m4["<b>完成</b>"]:::defaultBox
    
    m1 --> m2 --> m3 --> m4
    
    classDef defaultBox fill:#fff,stroke:#333,stroke-width:2px,color:#000
    classDef bbBox fill:#ccffcc,stroke:#00cc00,stroke-width:3px,color:#000,font-weight:bold
    classDef bobBox fill:#cce5ff,stroke:#0066cc,stroke-width:3px,color:#000,font-weight:bold
```
