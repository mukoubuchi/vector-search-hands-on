...
Vector Search ハンズオンにご参加いただき、ありがとうございました。今後の改善のため、率直なフィードバックをお寄せください。

!!! info "送信方法"
    ボタンを押すと Slack に貼り付けるためのメッセージが表示されます。コピーして指定の Slack チャンネルまたは DM に貼り付けて送信してください。

<form class="feedback-form" data-feedback-form data-feedback-lang="ja" markdown="1">
...
<label for="request-ja">その他ご意見ご要望をお寄せください。 <span class="feedback-optional">任意</span></label>
<textarea id="request-ja" name="その他ご意見ご要望" rows="4"></textarea>
  </section>
...
<p class="feedback-copy-title">Slack に貼り付ける内容</p>
<p class="feedback-copy-help">下の内容をコピーして、指定の Slack チャンネルまたは DM に貼り付けて送信してください。</p>
<textarea data-feedback-output rows="18" readonly aria-label="Slack に貼り付けるフィードバック内容"></textarea>
<div class="feedback-actions">
      <button type="button" data-feedback-copy>コピー</button>
