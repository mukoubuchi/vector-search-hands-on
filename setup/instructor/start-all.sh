...
echo "📝 次のステップ:"
echo ""
echo "  1. 受講者に共有する情報（ローカル配信の場合）:"
echo "     - Milvusホスト: $(get_ip_address):19530"
echo "     - ドキュメント: http://$(get_ip_address):8001"
echo ""
echo "  2. リモート参加者向けの配信方法:"
echo "     - GitHub Pages（推奨）: setup/instructor/deploy-docs-to-cloud.md 参照"
echo "     - ngrok（一時的）: ngrok http 8001"
echo ""
echo "  3. ドキュメント編集が必要な場合:"
